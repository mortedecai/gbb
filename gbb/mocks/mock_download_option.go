...
// Source: github.com/mortedecai/gbb/gbb (interfaces: DownloadOption)
//
// Generated by this command:
//
//	mockgen -destination=./mocks/mock_download_option.go -package=mocks github.com/mortedecai/gbb/gbb DownloadOption
//
