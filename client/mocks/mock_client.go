...
// Source: github.com/mortedecai/client/client (interfaces: GBBClient)
//
// Generated by this command:
//
//	mockgen -destination=./mocks/mock_client.go -package=mocks github.com/mortedecai/client/client GBBClient
//
