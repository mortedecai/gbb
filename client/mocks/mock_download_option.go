...
// Source: github.com/mortedecai/client/client (interfaces: DownloadOption)
//
// Generated by this command:
//
//	mockgen -destination=./mocks/mock_download_option.go -package=mocks github.com/mortedecai/client/client DownloadOption
//
