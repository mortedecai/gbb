...
// Source: github.com/mortedecai/client/client (interfaces: CommandOption)
//
// Generated by this command:
//
//	mockgen -destination=./mocks/mock_root_option.go -package=mocks github.com/mortedecai/client/client CommandOption
//
